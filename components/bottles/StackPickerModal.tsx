      ...
      >
        ...
        <ul className="overflow-y-auto p-3 space-y-1.5">
          {items.map((item) => {
              ...
              return (
                <li key={`tower-${tower.id}`}>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="font-medium text-sm text-slate-900">Your signal tower</p>
            ...
            return (
              <li key={`tower-${tower.id}`}>
                <div className="w-full flex items-center gap-3 rounded-lg border border-slate-100 bg-slate-50/80 p-3 text-left opacity-75">
